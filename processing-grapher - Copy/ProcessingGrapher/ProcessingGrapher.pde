...
// Add after other imports and before setup()
...
final int LOGIN_BOX_WIDTH = 300;
final int LOGIN_BOX_HEIGHT = 200;
final int INPUT_FIELD_WIDTH = 200;
final int INPUT_FIELD_HEIGHT = 30;
...
void setupLogin() {
  ...
  usernameField = new TextField(centerX - INPUT_FIELD_WIDTH/2, 
                              centerY - 40,
                              INPUT_FIELD_WIDTH, 
                              INPUT_FIELD_HEIGHT, 
                              false);
  passwordField = new TextField(centerX - INPUT_FIELD_WIDTH/2, 
                              centerY + 10,
                              INPUT_FIELD_WIDTH, 
                              INPUT_FIELD_HEIGHT, 
                              true);
...
void drawLoginScreen() {
  ...
  stroke(150);
  rectMode(CENTER);
  rect(centerX, centerY, LOGIN_BOX_WIDTH, LOGIN_BOX_HEIGHT);
  rectMode(CORNER);
  ...
  textSize(24);
  text("Processing Grapher Login", centerX, centerY - 80);
  
  // Labels
  textAlign(RIGHT, CENTER);
  textSize(14);
  text("Username:", centerX - INPUT_FIELD_WIDTH/2 - 10, centerY - 40 + INPUT_FIELD_HEIGHT/2);
  text("Password:", centerX - INPUT_FIELD_WIDTH/2 - 10, centerY + 10 + INPUT_FIELD_HEIGHT/2);
  ...
  // Login button
  fill(100);
  rect(centerX - 40, centerY + 60, 80, 30);
  fill(255);
  textAlign(CENTER, CENTER);
  text("Login", centerX, centerY + 75);
  
  // Error message
  if (!loginErrorMessage.isEmpty()) {
    fill(255, 0, 0);
    textAlign(CENTER, CENTER);
    text(loginErrorMessage, centerX, centerY + 100);
  }
}
